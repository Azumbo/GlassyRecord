...
enum UsageFeature: String, CaseIterable, Identifiable {
    ...
    var titleRU: String {
        ...
        case .backgroundBlurChanged: "Размытие фона"
        case .glassesToggled: "Очки вкл/выкл"
        case .glassesColorChanged: "Цвет очков"
        case .touchIndicatorShown: "Индикатор касания"
        case .demoBrowserOpened: "Демо-браузер"
        case .demoPresetOpened: "Пресет демо-сайта"
        case .appLaunchRequested: "Открыть приложение"
