...
enum UsageFeature: String, CaseIterable, Identifiable {
    ...
    case backgroundBlurChanged = "background_blur_changed"
    ...
    case demoBrowserOpened = "demo_browser_opened"
    case demoPresetOpened = "demo_preset_opened"
    case appLaunchRequested = "app_launch_requested"
    ...
    /// Локализованный заголовок для экрана статистики.
    var displayTitle: String {
        L10n.key("usage.feature.\(rawValue)")
    }

    /// Для текстового handoff-отчёта (Cursor) — всегда EN, стабильный формат.
    var titleEN: String {
        switch self {
        case .appLaunched: "App launch"
        case .homeOpened: "Home"
        case .settingsOpened: "Settings"
        case .usageStatsOpened: "Usage stats"
        case .usageReportCopied: "Report copied"
        case .usageReset: "Stats reset"
        case .recordingOpened: "Recording screen"
        case .broadcastPrepare: "Broadcast prepare"
        case .broadcastStarted: "Broadcast started"
        case .broadcastStopRequested: "Broadcast stop requested"
        case .broadcastStopSucceeded: "Broadcast stop OK"
        case .broadcastStopFailed: "Broadcast stop failed"
        case .broadcastFinished: "Broadcast finished"
        case .recordingFailed: "Recording failed"
        case .exitRecording: "Exit recording"
        case .pipActivated: "PiP Face Cam"
        case .pipSizePreset: "PiP face zoom"
        case .pipAspectChanged: "PiP aspect"
        case .backgroundBlurChanged: "Background blur"
        case .glassesToggled: "Glasses on/off"
        case .glassesColorChanged: "Glasses color"
        case .touchIndicatorShown: "Touch indicator"
        case .demoBrowserOpened: "Demo browser"
        case .demoPresetOpened: "Demo preset"
        case .appLaunchRequested: "Open app"
        case .micToggled: "Microphone"
        case .qualityChanged: "Quality"
        case .faceCamCornerChanged: "Face Cam corner"
        case .faceCamShapeChanged: "Face Cam shape"
        case .faceCamMirrorToggled: "Face Cam mirror"
        case .systemAudioToggled: "System audio"
        case .touchIndicatorsToggled: "Touch indicators"
        case .lowPowerAwareToggled: "Low Power aware"
        case .glassesDefaultToggled: "Glasses default"
        case .editorOpened: "Editor"
        case .exportSucceeded: "Saved to Photos"
        case .exportFailed: "Export failed"
        case .trimUsed: "Trim used"
        }
    }
}
